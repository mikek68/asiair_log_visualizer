...
ActiveRecord::Schema[8.0].define(version: 2025_01_11_202031) do
  create_table "active_storage_attachments", force: :cascade do |t|
    ...
    t.integer "num_lines", default: 0, null: false
  ...
  create_table "auto_runs", force: :cascade do |t|
    t.bigint "log_id"
    t.bigint "plan_id"
    t.string "name"
  ...
  create_table "exposure_groups", force: :cascade do |t|
  ...
  create_table "shooting_stages", force: :cascade do |t|
    t.bigint "auto_run_id"
    t.bigint "log_id"
  ...
  create_table "stage_processes", force: :cascade do |t|
    t.bigint "auto_run_id"
    t.bigint "log_id"
    t.bigint "shooting_stage_id"
