...
document.addEventListener("turbo:load", function() {
  console.log("Hello again from gantt_chart.js");
  const elements = document.getElementsByClassName("view-log-messages");
  for (let i = 0; i < elements.length; i++) {
    elements[i].addEventListener("click", logMessagesButtonClick);
  }
  ;
  function logMessagesButtonClick(event) {
    console.log("clicked");
...
document.addEventListener("turbo:load", function() {
  const elements = document.getElementsByClassName("log-messages");
...
bootstrap/dist/js/bootstrap.esm.js:
  (*!
    ...
    *)
*/
//# sourceMappingURL=/assets/application-18ca90a9.js.map
