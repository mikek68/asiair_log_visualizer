...
document.addEventListener("DOMContentLoaded", () => {
  ...
  gantt.config.columns = [
    { name: "text", label: "Task name", width: 200, resize: false, tree: true },
    { name: "start_date", label: "Start Time", align: "center", resize: false, width: 200 },
    { name: "end_date", label: "End Time", align: "center", resize: false, width: 200 },
    { name: "log_messages", label: "Log Messages", align: "center", resize: false, width: 160 }
  ];
  ...
  gantt.config.date_grid = "%Y-%m-%d %H:%i:%s %a";
  gantt.setSkin("dark");
...
bootstrap/dist/js/bootstrap.esm.js:
  (*!
    ...
    *)
*/
//# sourceMappingURL=/assets/application-ad4cdd59.js.map
